...
class SmsTemplatesActions extends Column
{
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'smsnotification/smstemplates/edit';
    /**
     * Url path  to delete
     *
     * @var string
     */
    const URL_PATH_DELETE = 'smsnotification/smstemplates/delete';
    /**
     * URL builder
     *
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'confirm' => [
                                ...
                                'message' => __(
                                    'Are you sure you wan\'t to delete the Template "${ $.$data.template_name  }" ?'
                                )
                            ]
                        ]
                    ];
