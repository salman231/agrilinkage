...
namespace Sunbrains\SMSProfile\Model\Config\Cron;
...
class SMSProfileConfig extends \Magento\Framework\App\Config\Value
{
    ...
    {
        $time = $this->getData('groups/smsprofilelog/fields/time/value');
        $frequency = $this->getData('groups/smsprofilelog/fields/cron_frequency/value');
