...
namespace Sunbrains\CustomerAttribute\Block\Adminhtml\Customer\Edit;
    ...
    public function initForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'abis_number',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('ABIS Number'),
                'title' => __('ABIS Number'),
                'value' => $partner['abis_number'],
            ]
        );

        $fieldset->addField(
            'sagicor_bank_account_number',
            'text',
            [
                'name' => 'sagicor_bank_account_number',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('Sagicor Bank Account Number'),
                'title' => __('Sagicor Bank Account Number'),
                'value' => $partner['sagicor_bank_account_number'],
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'data-form-part' => $this->getData('target_form'),
                'label' => __('What Do You Sell'),
                'title' => __('What Do You Sell'),
                'value' => $partner['what_do_you_sell'],
            ]
        );
