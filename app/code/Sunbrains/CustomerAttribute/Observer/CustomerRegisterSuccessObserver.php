        ...
        try {
            ...
            if (!empty($paramData['is_seller']) && !empty($paramData['profileurl']) && $paramData['is_seller'] == 1) {
                ...
                if (!$profileurlcount->getSize()) {
                    ...
                    $model->setData('abis_number', $paramData['abis_number']);
                    $model->setData('sagicor_bank_account_number', $paramData['sagicor_bank_account_number']);
                    $model->setData('what_do_you_sell', $paramData['what_do_you_sell']);
                    $model->setData('parish', $paramData['parish']);
					if(isset($paramData['paris'])) {
						$model->setData('parish', $paramData['paris']);
					}
                    //$model->setData('broker', $paramData['broker']);
